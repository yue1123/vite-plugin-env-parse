interface AutoGenerateImportMetaEnv {
   ...
   */
  readonly VITE_APP_FEATURE_FLAG_1: string
  /**
  ...
  readonly VITE_APP_NAME1111: string
  readonly VITE_APP_NAME2222: string
  /**
   * development local env
   * VITE_APP_NAME="dev local app name"
   */
  readonly VITE_APP_NAMEFDSSSSSSSSSSSSSSSSSSSSS: string
  readonly VITE_APP_PROCESS_ENVVVVVVVVVVVVVVVVVVVVVV: string
}
